        ...
        def segmentWithMeCab(input):
            ...
            for doc in result.split('EOS'):
                ...
                for line in doc.split('\n'):
                    if (u'名詞' in line or u'形容詞' in line) and u'接尾' not in line and u'接頭' not in line and u'非自立' not in line and u'代名詞' not in line and u'数' not in line:
...
if __name__ == '__main__':
    corpus = JapaneseTextCorpus('input.txt', 'utf-8', JapaneseSegmenter.mecab('utf-8'))

    lda = gensim.models.ldamodel.LdaModel(corpus=corpus, num_topics=3, id2word=corpus.dictionary)
